...
{
    public class PixelData24bpp : IPixelData
    {
        public int Width
        {
            get
        ...
        GCHandle m_Handle;
        byte[] m_Data;
        public PixelData24bpp(int Width, int Height, int Stride) : this(Width, Height, Stride, IntPtr.Zero)
        {

        }
        public PixelData24bpp(int Width, int Height, int Stride, IntPtr Scan0)
        {
            m_Width = Width;
            m_Height = Height;
            m_Stride = Stride;
            ...
            m_Format = PixelFormat.Format24bppRgb;
        }
        public void Dispose()
        {
            m_Width = 0;
